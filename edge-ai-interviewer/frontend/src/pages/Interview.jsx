        ...
        <form onSubmit={handleSetupSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
          ...
          <div style={{
            ...
            <p style={{ margin: 0, fontSize: '0.78rem', color: '#475569', lineHeight: 1.5 }}>
              Questions are generated by a <b style={{ color: '#0ea5e9' }}>local LLaMA3 model</b> tailored
              to your role, skills, and experience level. If the AI service is offline, a curated
