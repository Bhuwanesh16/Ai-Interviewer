...
const AudioWave = ({ mediaStream, isRecording }) => {
  ...
  return (
    <div style={{
      ...
      border: `1px solid ${isRecording ? 'rgba(56,189,248,0.15)' : 'rgba(56,189,248,0.06)'}`,
      background: 'rgba(8,20,40,0.8)',
      backdropFilter: 'blur(12px)',
      padding: '1rem',
      transition: 'border-color 0.3s ease',
      boxShadow: isRecording ? '0 0 20px rgba(56,189,248,0.06)' : 'none',
    }}>
      {/* Header */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.75rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          <div style={{
            ...
            background: isRecording ? '#38bdf8' : '#1e293b',
            boxShadow: isRecording ? '0 0 6px rgba(56,189,248,0.8)' : 'none',
          ...
          <span style={{
            ...
            fontSize: '0.8rem',
            fontWeight: 500,
            color: isRecording ? '#64748b' : '#1e3a5f',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
          <span style={{
            ...
            color: isRecording ? '#38bdf8' : '#1e293b',
            transition: 'color 0.3s ease',
          }}>
